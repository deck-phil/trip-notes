      ...
      <div className="weather-current">
        ...
        <p className="weather-meta">
          ...
          {formatNumber(
            ...
            weather.current.wind_speed_unit ?? "",
          )}
        </p>
      </div>
              ...
              <div className="weather-day-extra">
                {Number(day.precipitation_sum) > 1 ? (
                  <>
                    <span>
                      Precip:{" "}
                      {formatNumber(day.precipitation_sum, precipitationUnit)}
                    </span>
                    &nbsp;
                  </>
                ) : null}
                <span>Wind: {formatNumber(day.wind_speed_max, windUnit)}</span>
              </div>
            </li>
          );
        })}
